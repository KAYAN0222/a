...
class ChatbotController extends Controller
{
    ...
    {
        // سياق الشركة
        $systemPrompt = "أنت مساعد ذكي لشركة إبداع سوفت للأنظمة الخاصة المحدودة في اليمن.
الشركة تأسست عام 2012 وتقدم أنظمة محاسبية وإدارية متخصصة.
أنظمتها الرئيسية: DOTX Pro للمحاسبة، نظام المدارس نون، نظام الصراف المتقدم، نظام المستشفيات، نظام الفنادق، وغيرها.
العنوان: صنعاء - شارع مأرب - عمارة الأكوع - الدور الرابع.
الهاتف: 01 337571/72/73/74/75.
